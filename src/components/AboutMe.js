        ...
        <div className="container py-5">
            <div className="row">
                ...
                <div className="col-lg-6 col-xm-12">
                    ...
                    <p>
                        Hello! I am Onkar. I have been developing websites for over 5 years. I'm Full-Stack Web Developer. Technologies I use are Core Java, SpringBoot and MERN(MongoDB, Express, ReactJS and NodeJS).
